...
import me.sjnez.renosense.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = RenoSense.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (RenoSense.moduleManager.isModuleEnabled(FontMod.class)) {
            if (shadow) {
