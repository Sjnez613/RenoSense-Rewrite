    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : RenoSense.moduleManager.getCategories()) {
                ...
                for (Module module : RenoSense.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = RenoSense.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = RenoSense.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
