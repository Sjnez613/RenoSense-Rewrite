...
public class RPC extends Module {
    ...
    public RPC() {
        ...
        this.state = (Setting<String>) this.register(new Setting("State", "RenoSense Rewrite 0.6", "Sets the state of the DiscordRPC."));
        this.largeImageText = (Setting<String>) this.register(new Setting("LargeImageText", "RenoSense Rewrite 0.6", "Sets the large image text of the DiscordRPC."));
