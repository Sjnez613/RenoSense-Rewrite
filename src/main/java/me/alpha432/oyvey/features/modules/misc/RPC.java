...
public class RPC extends Module {
    ...
    public Setting<String> state = (Setting<String>) this.register(new Setting("State", "RenoSense Rewrite 0.6.5", "Sets the state of the DiscordRPC."));
    public Setting<String> largeImageText = (Setting<String>) this.register(new Setting("LargeImageText", "RenoSense Rewrite 0.6.5", "Sets the large image text of the DiscordRPC."));
