...
public class BlockInteractionHelper
{
    ...
    private static void processRightClickBlock(final BlockPos pos, final EnumFacing side, final Vec3d hitVec) {
        getPlayerController().processRightClickBlock(mc.player, BlockInteractionHelper.mc.world, pos, side, hitVec, EnumHand.MAIN_HAND);
    }
    ...
    static {
        ...
        BlockInteractionHelper.fmlHandler = FMLCommonHandler.instance();
    }
}